...
public class LongClickReceiver extends BroadcastReceiver {
    ...
    public static WeakReference<NightFallLauncher> mWeakReference = new WeakReference(null);

    public static void getWeakReference(NightFallLauncher launcher) {
        mWeakReference = new WeakReference(launcher);
    }

    @Override
    public void onReceive(Context context, Intent intent) {
        NightFallLauncher launcher = (NightFallLauncher) mWeakReference.get();
        if (launcher != null) {
