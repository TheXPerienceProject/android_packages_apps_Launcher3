 ...
 */
package mx.xperience.launcher.qsb.configs;
...
import mx.xperience.launcher.NightFallLauncher;
import mx.xperience.launcher.NightFallLauncherCallbacks;
import mx.xperience.launcher.qsb.AllAppsQsbContainer;
import mx.xperience.launcher.search.nano.SearchProto.Columns;
import mx.xperience.launcher.search.nano.SearchProto.AppIndex;
import mx.xperience.launcher.search.nano.SearchProto.SearchBase;
import mx.xperience.launcher.search.nano.SearchProto.SearchView;
import mx.xperience.launcher.search.AppSearchProvider;
...
public class ConfigurationBuilder {
    ...
    public NightFallLauncher mLauncher;
    ...
    public static Intent getSearchIntent(Rect sourceBounds, View gIcon, View micIcon) {
        ...
        return intent.putExtra("source_round_left", true)
                ...
                .setPackage(NightFallLauncherCallbacks.SEARCH_PACKAGE).addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY | Intent.FLAG_ACTIVITY_NEW_TASK);
    }
